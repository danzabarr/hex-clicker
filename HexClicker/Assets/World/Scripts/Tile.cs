...
namespace HexClicker.World
{
    ...
    public class Tile : MonoBehaviour
    {
        ...
        */
        ...
        void Awake()
        {
            maskCamera.orthographicSize = Map.TileSize;
            maskCoverer.transform.localScale = Vector3.one * Map.TileSize * .2f;
        }
        ...
        public void GenerateMesh(Map map, int x, int y, bool fixNormalsAtSeams)
        {
            int res = Map.TileResolution;
